...
import rikkei.android.customview.lib.model.Corner;
import rikkei.android.customview.lib.model.RkRoundedDrawable;

/**
 * Created by tuyenpx on 24/05/2016.
 *
 * <p/>
 * this class support to custom Rounded Image View , Image View rectangle with corner .
 * oval or circle .
 * - corner_radius_top_left, corner_radius , corner_radius_top_right ,corner_radius_bottom_right , corner_radius_bottom_left are  only use for image rectangle .
   - riv_border_width : width of border in image view .
   - riv_border_color : color of border in image view .
   - riv_oval  : image is a oval
   - riv_circle : image is a circle .
   - default is a rectangle with out border .
   - android_scaleType : default attributes scaleType of ImageView android .
 *
 */


@SuppressWarnings("UnusedDeclaration")
public class RkRoundedImageView extends ImageView {
    // Constants for tile mode attributes
    private static final int TILE_MODE_UNDEFINED = -2;
    private static final int TILE_MODE_CLAMP = 0;
    private static final int TILE_MODE_REPEAT = 1;
    private static final int TILE_MODE_MIRROR = 2;
    public static final String TAG = RkRoundedImageView.class.getSimpleName();
    ...
    private ColorStateList mBorderColor =
            ColorStateList.valueOf(RkRoundedDrawable.DEFAULT_BORDER_COLOR);
    ...
    public RkRoundedImageView(Context context) {
        super(context);
    }

    public RkRoundedImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RkRoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        float cornerRadiusOverride =
                a.getDimensionPixelSize(R.styleable.RoundedImageView_rikkei_riv_corner_radius, -1);

        mCornerRadii[Corner.TOP_LEFT] =
                a.getDimensionPixelSize(R.styleable.RoundedImageView_rikkei_riv_corner_radius_top_left, -1);
        mCornerRadii[Corner.TOP_RIGHT] =
                a.getDimensionPixelSize(R.styleable.RoundedImageView_rikkei_riv_corner_radius_top_right, -1);
        mCornerRadii[Corner.BOTTOM_RIGHT] =
                a.getDimensionPixelSize(R.styleable.RoundedImageView_rikkei_riv_corner_radius_bottom_right, -1);
        mCornerRadii[Corner.BOTTOM_LEFT] =
                a.getDimensionPixelSize(R.styleable.RoundedImageView_rikkei_riv_corner_radius_bottom_left, -1);
        ...
        mBorderWidth = a.getDimensionPixelSize(R.styleable.RoundedImageView_rikkei_riv_border_width, -1);
        if (mBorderWidth < 0) {
            mBorderWidth = DEFAULT_BORDER_WIDTH;
        }

        mBorderColor = a.getColorStateList(R.styleable.RoundedImageView_rikkei_riv_border_color);
        if (mBorderColor == null) {
            mBorderColor = ColorStateList.valueOf(RkRoundedDrawable.DEFAULT_BORDER_COLOR);
        }
        mIsOval = a.getBoolean(R.styleable.RoundedImageView_rikkei_riv_oval, false);
        mIsCircle= a.getBoolean(R.styleable.RoundedImageView_rikkei_riv_circle, false);
        updateDrawableAttrs();
        a.recycle();
    }
    ...
    public void setImageDrawable(Drawable drawable) {
        mResource = 0;
        mDrawable = RkRoundedDrawable.fromDrawable(drawable);
        updateDrawableAttrs();
    ...
    public void setImageBitmap(Bitmap bm) {
        mResource = 0;
        mDrawable = RkRoundedDrawable.fromBitmap(bm);
        updateDrawableAttrs();
        super.setImageDrawable(mDrawable);
    }
    ...
    private Drawable resolveResource() {
        ...
        return RkRoundedDrawable.fromDrawable(d);
    }
    ...
    private Drawable resolveBackgroundResource() {
        ...
        if (mBackgroundResource != 0) {
            if (mResource != 0) {
                d = ContextCompat.getDrawable(getContext(), mBackgroundResource);
            }
        }
        return RkRoundedDrawable.fromDrawable(d);
    }
    ...
    private void updateAttrs(Drawable drawable, ScaleType scaleType) {
        ...
        if (drawable instanceof RkRoundedDrawable) {
            ((RkRoundedDrawable) drawable)
            ...
            if (mCornerRadii != null) {
                ((RkRoundedDrawable) drawable).setCornerRadius(
                        mCornerRadii[Corner.TOP_LEFT],
                        mCornerRadii[Corner.TOP_RIGHT],
                        mCornerRadii[Corner.BOTTOM_RIGHT],
                        mCornerRadii[Corner.BOTTOM_LEFT]);
    ...
    public void setBorderColor(ColorStateList colors) {
        ...
        mBorderColor =
                (colors != null) ? colors : ColorStateList.valueOf(RkRoundedDrawable.DEFAULT_BORDER_COLOR);
        updateDrawableAttrs();
        if (mBorderWidth > 0) {
            invalidate();
        }
