...
public class RkRoundedDrawable extends Drawable {
    public static final String TAG = RkRoundedDrawable.class.getSimpleName();
    ...
    public RkRoundedDrawable(Bitmap bitmap) {
        mBitmap = bitmap;
    ...
    public static RkRoundedDrawable fromBitmap(Bitmap bitmap) {
        if (bitmap != null) {
            return new RkRoundedDrawable(bitmap);
        } else {
            return null;
        }
    }
    ...
    public static Drawable fromDrawable(Drawable drawable) {
        if (drawable != null) {
            ...
            if (bm != null) {
                return new RkRoundedDrawable(bm);
            }
        }
        return drawable;
    }
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        if (mOval) {
            ...
            if (mBorderWidth > 0) {
                canvas.drawCircle(mBorderRect.centerX(), mBorderRect.centerY(), mBorderRect.centerX() / 2 + mBorderWidth / 2, mBorderPaint);
                canvas.drawCircle(mDrawableRect.centerX(), mDrawableRect.centerY(), mDrawableRect.centerX() / 2, mBitmapPaint);
            } else {
                canvas.drawCircle(mDrawableRect.centerX(), mDrawableRect.centerY(), mDrawableRect.centerX() / 2, mBitmapPaint);
            }
        } else {
     ...
     * @return the {@link RkRoundedDrawable} for chaining.
     */
    public RkRoundedDrawable setCornerRadius(float radius) {
     ...
     * @return the {@link RkRoundedDrawable} for chaining.
     */
    public RkRoundedDrawable setCornerRadius(@Corner int corner, float radius) {
     ...
     * @return the {@link RkRoundedDrawable} for chaining.
     */
    public RkRoundedDrawable setCornerRadius(float topLeft, float topRight, float bottomRight,
                                             float bottomLeft) {
    ...
    public RkRoundedDrawable setBorderWidth(float width) {
        mBorderWidth = width;
        mBorderPaint.setStrokeWidth(mBorderWidth);
        return this;
    }
    ...
    public RkRoundedDrawable setBorderColor(@ColorInt int color) {
    ...
    public RkRoundedDrawable setBorderColor(ColorStateList colors) {
    ...
    public RkRoundedDrawable setOval(boolean oval) {
        mOval = oval;
        return this;
    }

    public RkRoundedDrawable setCircle(boolean circle) {
        mCircle = circle;
        return this;
    }
    ...
    public RkRoundedDrawable setScaleType(ScaleType scaleType) {
        if (scaleType == null) {
    ...
    public RkRoundedDrawable setTileModeX(Shader.TileMode tileModeX) {
    ...
    public RkRoundedDrawable setTileModeY(Shader.TileMode tileModeY) {
